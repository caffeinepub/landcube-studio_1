...
export class Backend implements backendInterface {
    ...
    async createProject(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: Array<string>): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getProjectById(arg0: bigint): Promise<Project> {
        if (this.processError) {
            try {
    ...
    async updateProject(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: Array<string>): Promise<void> {
        if (this.processError) {
            try {
